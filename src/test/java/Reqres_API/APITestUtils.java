...
public class APITestUtils extends ExtentSparkReport {


    public EmailAttachment attachment;
    public MultiPartEmail email;

    public ReqresServiceHelper reqresServiceHelper;
    ...
    public void preConditions(ITestContext suiteName){
        ...
        initialise(path, CommonUtility.readPropertyFile(FilePaths.EXTENT_REPORT_PROPERTIES).getProperty("APIProjectName"));
        reqresServiceHelper = ReqresServiceHelper.getInstance();
    ...
    public void sendEmail()
    {
        ...
        attachment.setDescription(emailProperties.getProperty("reqresAPIMailDescription"));
        attachment.setName(emailProperties.getProperty("reqresAPIMailName"));
        ...
        email.setSubject(emailProperties.getProperty("reqresAPISuiteSubject"));
        email.setMsg(emailProperties.getProperty("reqresAPIMailMsg"));
